...
import { FaBuilding, FaLayerGroup, FaTag, FaPaperclip, FaEye, FaCalendarAlt } from 'react-icons/fa';
  ...
  if (tickets.length === 0) {
    return (
      <div className="p-8 text-center text-white/40">
        ...
        <p className="text-white/60">Try adjusting your filters or create a new ticket</p>
      </div>
    );
  }
